...
20 07 08 09 10
21 22 23 24 25
You might easily notice that the first - and innermost - layer containes only one number (01), the second one - immediately around 
it - contains 8 numbers (number in the 02-09 range) and so on.
...
class Kata
{
    public static int Layers(int n)
    {
        int k = 1;
        while ((2 * k - 1) * (2 * k - 1) < n)
        {
